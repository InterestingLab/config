...
import com.typesafe.config.waterdrop.{ConfigException, ConfigParseOptions, ConfigSyntax}
import com.typesafe.config.waterdrop.{ConfigException, ConfigParseOptions}
